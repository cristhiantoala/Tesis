...
function validar()
{
alert(document.getElementById("txt_Res").value);
/*else 
	alert(document.getElementById("txt_Res").value)
	return true;*/
}
...
var questionTemplate = _.template(" \
	...
	<li> \
          <textarea name='txtRes' id='txt_Res'> </textarea> \
		  </li> \
		<ul class='options'> \
        <li> \
          <input type='radio' name='question[<%= index %>]' value='1' id='q<%= index %>o2' Onclick='validar()'> \
