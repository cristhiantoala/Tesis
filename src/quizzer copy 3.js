...
$(function() {
	...
	function moveToNextQuestion() {
		...
		if (currentQuestion==2 || currentQuestion==5 || currentQuestion==8 || currentQuestion==11|| acurrentQuestionux==15)
		{	
	...
	function dontmoveToNextQuestion() {
		
		currentQuestion += 1;
		$('.question.card:nth-child(' + (currentQuestion) + ')').hide();
